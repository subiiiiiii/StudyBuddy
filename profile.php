...
function getAllResources($connection) {
    ...
    $sql = "SELECT * FROM `resource` WHERE is_active = 1 AND uploaded_by = '".$_SESSION['user_id']."'";
        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2" src="form_handlers/<?php echo $row['display_picture'];  ?>" alt="">
                    <!-- Profile picture upload button-->
                    <button class="btn btn-primary" type="button"><?php echo $row['first_name']; ?> <?php echo $row['last_name']; ?></button>
                </div>
            </div>
            <div class="card mb-4">
                <div class="card-header">Account Details</div>
                <div class="card-body">
                    <form action="form_handlers/profile_handler.php" method="post" enctype="multipart/form-data">
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
                            <!-- Form Group (first name)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="fname">First name</label>
                                <input class="form-control" name="fname" id="fname" type="text" placeholder="Enter your first name" value="<?php echo $row['first_name']; ?>">
                            </div>
                            <!-- Form Group (last name)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="lname">Last name</label>
                                <input class="form-control" name="lname" id="lname" type="text" placeholder="Enter your last name" value="<?php echo $row['last_name']; ?>">
                            </div>
                        </div>
                        <!-- Form Row        -->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="email" name="email" type="email" placeholder="Enter your email" value="<?php echo $row['email']; ?>">
                            </div>
                            <!-- Form Group (location)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="dob">Date of Birth</label>
                                <input class="form-control" id="dob" name="dob" type="date" placeholder="Select" value="<?php echo $row['date_of_birth']; ?>">
                            </div>
                        </div>
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="pic">Picture</label>
                                <img src="form_handlers/<?php echo $row['display_picture'];  ?>" width="100" height="100"/>
                                <input type="hidden" name="pic_data" value="<?php echo $row['display_picture'];  ?>">
                                ...
                                <div class="img-card iCard-style1">
                                    <div class="card-content">
                                        <div class="card-image">
                                            <span class="card-title" style="background:gray;"><?php echo $resource['title']; ?></span>
                                            <a href="card.php?resource_id=<?php echo $resource['resource_id']; ?>">
                                                <img src="form_handlers/<?php echo $resource['header_image']; ?>"/>
                                            </a>
                                        </div>
                                    ...
                                    <div class="card-link">
                                        <a href="card.php?resource_id=<?php echo $resource['resource_id']; ?>" title="View Full"><span>View Full</span></a>
                                    </div>
                                </div>
                            </li>
                            <?php
